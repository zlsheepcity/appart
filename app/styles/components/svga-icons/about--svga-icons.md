...
<figure class="svga-icon"><svg><use href="app/styles/components/svga-icons/svga-icons.svg#svg-email"></use></svg></figure>

<!-- Reference IN THIS SAME DOCUMENT -->

<figure class="svga-icon"><svg><use href="#svg-email"></use></svg></figure>

<svg>
    <symbol id="svg-next" viewBox="0 0 24 24">
        <!-- Arrow Next, material icons -->
    ...
    <symbol id="svg-github" viewBox="0 0 448 512">
        <!-- Github Square, font-awesome -->
